const Navbar = ({ stepDescriptions: descriptions, activeStep }) => {
  ...
  return (
    <div className="md:basis-1/3 z-0 navbar__img md:rounded-xl  bg-clip-border bg-cover bg-[url('../../assets/images/bg-sidebar-mobile.svg')] md:bg-[url('../../assets/images/bg-sidebar-desktop.svg')]">
      <ul className="flex flex-row py-16 md:px-10 md:py-20 md:flex-col md:items-start justify-center items-center uppercase text-base text-slate-50 font-extrabold">
